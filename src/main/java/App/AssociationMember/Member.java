...
public class Member extends Personne{
    ...
    private static final double MONTANT_COTISATION = 50.0; // Montant fixe de la cotisation
    private boolean cotisationPayee;

    public Member(String nom, String prenom, int age,String identifiant,String password) {
